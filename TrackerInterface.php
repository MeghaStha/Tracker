...
<head>
    ...
    <title>Tracks of <?php echo $_SESSION[ 'username']; ?></title>
    ...
    <script type="text/javascript" src="./js/tracker-interface.js"></script>
</head>
    ...
    <nav class="navbar navbar-default" id="navbar" role="navigation" style="height:78px">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a href="./interface.php" title="Click to to go Interface Page" style="float:left;margin-top:15px;margin-left:0px;">
