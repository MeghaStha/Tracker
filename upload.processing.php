...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
    ...
    if($image_res){
	    ...
	    unlink($content_person['image_link']);
            ...
            mysqli_query($con,"UPDATE user SET image_link='$image_save_folder' WHERE `username`='$username' && `id`='$id'");

            mysqli_query($con,"UPDATE person SET image_link='$image_save_folder' WHERE `username`='$username' && `person_id`='$id'");
